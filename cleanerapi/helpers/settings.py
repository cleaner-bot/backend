...
default_config = {
    ...
    "rules_advertisement_unsafelink": 1,
    "rules_advertisement_unsafelink_channels": [],
    "rules_emoji_mass": 0,
...
config_validators: dict[str, typing.Callable[..., bool]] = {
    ...
    "rules_advertisement_unsafelink": _cfg_fw_mode,
    "rules_advertisement_unsafelink_channels": validate_snowflakes,
